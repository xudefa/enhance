...
func TestHotReloader_DetectFileChange(t *testing.T) {
	...
	// 等待检测到变化并校验事件
	testHotReloaderDetectEvent(t, &wg, &events, &mu, ReloadTypeModified, testFile, "Timeout waiting for file change detection")
}
...
func TestHotReloader_DetectNewFile(t *testing.T) {
	...
	// 等待检测到变化并校验事件
	testHotReloaderDetectEvent(t, &wg, &events, &mu, ReloadTypeCreated, "", "Timeout waiting for new file detection")
}
...
func TestHotReloader_DetectFileDeletion(t *testing.T) {
	...
	// 等待检测到变化并校验事件
	testHotReloaderDetectEvent(t, &wg, &events, &mu, ReloadTypeDeleted, "", "Timeout waiting for file deletion detection")
}
