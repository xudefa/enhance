// Package main demonstrates the Casbin-GORM starter usage.
//
// This example shows how to use the Casbin-GORM starter to:
// 1. Auto-configure Casbin with GORM adapter
...
func main() {
	fmt.Println("=== Casbin-GORM Starter Example ===")
	fmt.Println()

	app, err := boot.NewApplication(
		boot.WithAppName("casbin-gorm-example"),
