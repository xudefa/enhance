module github.com/xudefa/enhance/examples/example-starter-nacos
...
require (
	...
	github.com/xudefa/enhance/starter/nacos v0.0.3
)
...
replace (
	...
	github.com/xudefa/enhance/starter/nacos => ../../starter/nacos
)
