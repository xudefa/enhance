...
func testHookOnInit(t *testing.T) {
	called := false
...
func testHookOnStop(t *testing.T) {
	called := false
...
func testHookNilNoPanic(t *testing.T) {
	hook := HookFunc{}
...
func TestHookFunc(t *testing.T) {
	t.Parallel()
	t.Run("OnInit called", testHookOnInit)
	t.Run("OnStart called", testHookOnStart)
	t.Run("OnStop called", testHookOnStop)
	t.Run("nil functions do not panic", testHookNilNoPanic)
}

func testHookRegistryExecuteOrder(t *testing.T) {
...
func testHookRegistryStopReverseOrder(t *testing.T) {
	registry := NewHookRegistry()
	var order []string
...
func testHookRegistryInitStopsOnError(t *testing.T) {
	registry := NewHookRegistry()
	registry.Register(OnInitFunc(func(ctx context.Context) error {
		return nil
	}))
...
func testHookRegistryGetAll(t *testing.T) {
	registry := NewHookRegistry()
	registry.Register(OnInitFunc(nil))
	registry.Register(OnStartFunc(nil))
...
func testHookRegistryConcurrent(t *testing.T) {
	registry := NewHookRegistry()
...
func TestHookRegistry(t *testing.T) {
	t.Parallel()
	t.Run("Register and execute hooks in order", testHookRegistryExecuteOrder)
	t.Run("StopAll executes in reverse order", testHookRegistryStopReverseOrder)
	t.Run("InitAll stops on first error", testHookRegistryInitStopsOnError)
	t.Run("RegisterFunc convenience method", testHookRegistryRegisterFunc)
	t.Run("Count returns correct number", testHookRegistryCount)
	t.Run("GetAll returns copy of hooks", testHookRegistryGetAll)
	t.Run("concurrent access", testHookRegistryConcurrent)
}
