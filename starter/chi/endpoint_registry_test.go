...
func TestChiEndpointRegistry_RegisterEndpoint(t *testing.T) {
	t.Parallel()

	router := chi.NewRouter()
	registry := NewChiEndpointRegistry(router)
...
func TestChiEndpointRegistry_RegisterEndpoints(t *testing.T) {
	t.Parallel()
...
func TestChiEndpointRegistry_RegisterEndpoint_Any(t *testing.T) {
	t.Parallel()
...
func TestChiEndpointRegistry_NilHandler(t *testing.T) {
	t.Parallel()
...
func TestChiEndpointRegistry_NilRouter(t *testing.T) {
	t.Parallel()

	registry := &ChiEndpointRegistry{
		router:    nil,
	...
	if registry.HasEndpoint("/test") {
		t.Error("Expected endpoint not to be registered with nil router")
	}
}

func TestChiEndpointRegistry_Interface(t *testing.T) {
	t.Parallel()
