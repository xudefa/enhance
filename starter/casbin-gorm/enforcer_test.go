...
func newTestEnforcer(t *testing.T) *GormCasbinEnforcer {
	t.Helper()
	...
	return &GormCasbinEnforcer{
		Enforcer: e,
		adapter:  nil,
	}
}

func TestGormCasbinEnforcer_Enforce(t *testing.T) {
	t.Parallel()
	e := newTestEnforcer(t)
...
func TestGormCasbinEnforcer_AddPolicy_RemovePolicy(t *testing.T) {
	t.Parallel()
	e := newTestEnforcer(t)
	ctx := context.Background()
...
func TestGormCasbinEnforcer_GetPolicy(t *testing.T) {
	t.Parallel()
	e := newTestEnforcer(t)
	ctx := context.Background()
...
func TestGormCasbinEnforcer_LoadPolicy(t *testing.T) {
	t.Parallel()
	e := newTestEnforcer(t)
	ctx := context.Background()
...
func TestGormCasbinEnforcer_SavePolicy(t *testing.T) {
	t.Parallel()
	e := newTestEnforcer(t)
	ctx := context.Background()
...
func TestGormCasbinEnforcer_InterfaceCompliance(t *testing.T) {
	t.Parallel()
	e := newTestEnforcer(t)
	var _ interface {
