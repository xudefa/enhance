...
func TestEchoEndpointRegistry_RegisterEndpoint(t *testing.T) {
	t.Parallel()

	engine := echo.New()
	registry := NewEchoEndpointRegistry(engine)
...
func TestEchoEndpointRegistry_RegisterEndpoints(t *testing.T) {
	t.Parallel()
...
func TestEchoEndpointRegistry_RegisterEndpoint_Any(t *testing.T) {
	t.Parallel()
...
func TestEchoEndpointRegistry_NilHandler(t *testing.T) {
	t.Parallel()
...
func TestEchoEndpointRegistry_NilEngine(t *testing.T) {
	t.Parallel()

	registry := &EchoEndpointRegistry{
		engine:    nil,
...
func TestEchoEndpointRegistry_Interface(t *testing.T) {
	t.Parallel()
