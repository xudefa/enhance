...
func TestCaffeineCache_GetSet(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(WithCaffeineMaxSize(10))
...
func TestCaffeineCache_GetSet_Overwrite(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(WithCaffeineMaxSize(10))
	ctx := context.Background()
...
func TestCaffeineCache_GetExpired(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(WithCaffeineMaxSize(10))
	ctx := context.Background()
...
func TestCaffeineCache_GetNotFound(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(WithCaffeineMaxSize(10))
	ctx := context.Background()
...
func TestCaffeineCache_Del_Existing(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(WithCaffeineMaxSize(10))
	ctx := context.Background()
...
func TestCaffeineCache_Del_NonExisting(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(WithCaffeineMaxSize(10))
	ctx := context.Background()
...
func TestCaffeineCache_Exists(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(WithCaffeineMaxSize(10))
	ctx := context.Background()
...
func TestCaffeineCache_Exists_NonExisting(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(WithCaffeineMaxSize(10))
	ctx := context.Background()
...
func TestCaffeineCache_Exists_Expired(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(WithCaffeineMaxSize(10))
	ctx := context.Background()
...
func TestCaffeineCache_TTL_WithTTL(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(WithCaffeineMaxSize(10))
	ctx := context.Background()
...
func TestCaffeineCache_TTL_NoTTL(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(WithCaffeineMaxSize(10))
	ctx := context.Background()
...
func TestCaffeineCache_TTL_NotFound(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(WithCaffeineMaxSize(10))
	ctx := context.Background()
...
func TestCaffeineCache_TTL_Expired(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(WithCaffeineMaxSize(10))
	ctx := context.Background()
...
func TestCaffeineCache_Close(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(WithCaffeineMaxSize(10))
	ctx := context.Background()
...
func TestCaffeineCache_Size(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(WithCaffeineMaxSize(10))
	ctx := context.Background()
...
func TestCaffeineCache_Clear(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(WithCaffeineMaxSize(10))
	ctx := context.Background()
...
func TestCaffeineCache_Stats(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(
		WithCaffeineMaxSize(100),
		WithCaffeineDefaultTTL(5*time.Minute),
	)
	ctx := context.Background()
...
func TestCaffeineCache_LRUEviction(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(WithCaffeineMaxSize(2))
	ctx := context.Background()
...
func TestCaffeineCache_WithCaffeineMaxSize(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(WithCaffeineMaxSize(5))
	if c.maxSize != 5 {
		t.Errorf("expected maxSize 5, got %d", c.maxSize)
	}
}

func TestCaffeineCache_WithCaffeineDefaultTTL(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(WithCaffeineDefaultTTL(10 * time.Minute))
	if c.defaultTTL != 10*time.Minute {
		t.Errorf("expected defaultTTL 10m, got %v", c.defaultTTL)
	}
}

func TestCaffeineCache_DefaultConfig(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache()
	if c.maxSize != 1000 {
...
func TestCaffeineCache_Set_NegativeTTL(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(
		WithCaffeineMaxSize(10),
		WithCaffeineDefaultTTL(50*time.Millisecond),
	)
	ctx := context.Background()
...
func TestCaffeineCache_Del_Multiple(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(WithCaffeineMaxSize(10))
	ctx := context.Background()
...
func TestCaffeineCache_LRU_Access_Updates_Position(t *testing.T) {
	t.Parallel()
	c := NewCaffeineCache(WithCaffeineMaxSize(2))
	ctx := context.Background()
