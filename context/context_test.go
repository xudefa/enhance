...
func newTestCtx(container core.Container, env *environment.Environment) *DefaultApplicationContext {
	return NewApplicationContext(container, env).(*DefaultApplicationContext)
}
